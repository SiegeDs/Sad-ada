...
<body style="background: #f1f2e8">
    ...
    <div class="container-fluid">
      <div class="container">
        <div class="d-flex justify-content-between">
          ...
          <nav class="nav m-2">
            <a class="nav-link text-light" aria-current="page" href="#">Chart
            </a>
  ...
  <!-- End of navbar-->
  <button type="button" class="btn btn-warning mb-2" style="margin-top: 150px; margin-left: 1100px;" id="create" data-toggle="modal" data-target="#CreateModal" onclick="setModalMode('create')">Create</button>
    ...
    <tbody>
      <?php while ($post = $post_results->fetch_assoc()) : ?>
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#CreateModal" onclick="setModalMode('update')">Edit</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <buttons type="button" class="close" data-dismiss="modal" aria-label="Close" style="width: 50px;">
